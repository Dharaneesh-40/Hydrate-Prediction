...
# PAGE CONFIGURATION
st.set_page_config( page_title="Hydrate+", page_icon="💧", layout="wide")
...
Receive personalized hydration insights, BMI evaluation,
and daily water recommendations through a simple and
...
"""
    ...
    st.info(  """Healthy adults should generally consume around **2–3 litres of water**per day.
...
"""
    ...
    with right:
        water = st.slider("Daily Water Intake (Litres)", 0.5, 8.0, 2.5, 0.1)
    ...
    if analyze:
        ...
        if water < 2:
        ...
        elif water <= recommended_water + 0.5:
            ...
            hydration_status = "🟠 High Water Intake"
            score = 70
            risk = "Moderate"
...
Recommended Intake : {recommended_water} L
...
# ABOUT PAGE
    ...
    st.write(
        """
Hydrate+ is a Smart Hydration Assessment System that helps users
evaluate their daily hydration status using personal and lifestyle
information.

The application combines machine learning predictions with
general health guidelines to provide easy-to-understand hydration
